...
- [ ] HID packet framing unit tests pass (`KeepKeyTransportProviderImpl`)
...
|---|---|---|
| Address display on physical KeepKey (USB OTG) | | |
| Shielded send — sign & broadcast | | |
| Device disconnected mid-signing | | |

...
internal object Blake2b {
    ...
    private val IV =
        longArrayOf(
            parseUnsignedLong("6a09e667f3bcc908", 16),
            parseUnsignedLong("bb67ae8584caa73b", 16),
            parseUnsignedLong("3c6ef372fe94f82b", 16),
            parseUnsignedLong("a54ff53a5f1d36f1", 16),
            parseUnsignedLong("510e527fade682d1", 16),
            parseUnsignedLong("9b05688c2b3e6c1f", 16),
            parseUnsignedLong("1f83d9abfb41bd6b", 16),
            parseUnsignedLong("5be0cd19137e2179", 16),
        )
